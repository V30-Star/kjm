@extends('layouts.app')
@section('title', 'Create Group Product')
    ...
    <div class="row">
        <div class="col-12">
            <div class="bg-white border rounded-3 p-3 d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">Create Group Product</h5><small class="text-secondary">Add a new group</small>
                </div>
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="bg-white border rounded-3 p-4">
                <form method="POST" action="{{ route('groupproduct.store') }}">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode_groupproduct"
                            ...
                            value="{{ old('kode_groupproduct') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_groupproduct"
                            ...
                            value="{{ old('name_groupproduct') }}" required>
