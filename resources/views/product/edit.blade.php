    ...
    <div class="row">
        <div class="col-12">
            <div class="bg-white border rounded-3 p-3 d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">Edit Product</h5><small class="text-secondary">Update product</small>
                </div>
                ...
                <form method="POST" action="{{ route('product.update', $p) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_barang"
                            ...
                            value="{{ old('name_barang', $p->name_barang) }}" required>
                        @error('name_barang')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" name="harga_modal"
                                ...
                                value="{{ old('harga_modal', $p->harga_modal) }}" required>
                            @error('harga_modal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" name="harga_akhir"
                                ...
                                value="{{ old('harga_akhir', $p->harga_akhir) }}" required>
                            @error('harga_akhir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
